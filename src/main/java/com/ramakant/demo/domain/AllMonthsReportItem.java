...
public class AllMonthsReportItem {
    ...
    public AllMonthsReportItem(String site, double requests, double impressions, double clicks, double conversions, double revenue) {
        this.site = site;
